...
function getTournamentOpen(){
  return new Date(Date.UTC(2026,2,26,9+etOff(),0,0));
}
function isTournamentOpen(){
  return new Date()>=new Date(Date.UTC(2026,2,26,9+etOff(),0,0));
}

// Warning banner: 5:37 PM CT on 3/25/2026
function getTournamentWarn(){
  return new Date(Date.UTC(2026,2,26,11+etOff(),45,0));
}
function isTournamentWarnTime(){
  return new Date()>=new Date(Date.UTC(2026,2,26,11+etOff(),45,0));
}
